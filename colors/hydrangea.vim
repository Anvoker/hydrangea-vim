...
hi Folded ctermfg=252 ctermbg=236 cterm=NONE guifg=#d3e7ff guibg=#2a303b gui=NONE
hi FoldColumn ctermfg=252 ctermbg=235 cterm=NONE guifg=#d3e7ff guibg=#1e222c gui=NONE
hi Title ctermfg=162 ctermbg=NONE cterm=bold guifg=#e242ac guibg=NONE gui=bold
hi StatusLine ctermfg=252 ctermbg=238 cterm=NONE guifg=#d3e7ff guibg=#3b4351 gui=NONE
...
hi Todo ctermfg=252 ctermbg=235 cterm=bold guifg=#d3e7ff guibg=#1e222c gui=bold
...
hi TabLineFill ctermfg=252 ctermbg=235 cterm=NONE guifg=#d3e7ff guibg=#1e222c gui=NONE
